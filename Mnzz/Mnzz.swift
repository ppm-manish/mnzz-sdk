...
public class Mnzz: UIControl {
  ...
  private let renderer = MnzzRenderer()
  ...
  private func commonInit() {
    ...
    let gestureRecognizer = RotationGestureRecognizer(target: self, action: #selector(Mnzz.handleGesture(_:)))
